...
(function (exports) {
  ...
  function sliceMeshcode(meshcode){
   ...
   exports.first = function (meshcode){
  ...
  exports.second = function (meshcode){
    var south, west, north, east;
    var lat, lng;
    var code = sliceMeshcode(meshcode);
  ...
  exports.third = function (meshcode){
    var south, west, north, east;
    var lat, lng;
    var code = sliceMeshcode(meshcode);
  ...
  exports.half = function (meshcode){
    var south, west, north, east;
    var lat, lng;
    var code = sliceMeshcode(meshcode);
    lat = code.p/1.5*3600 + code.q*5*60 + code.r*30;
    lng = (code.u+100)*3600 + code.v*7.5*60 + code.w*45;
    south = lat + (code.m > 2 ? 1 : 0) * 15;
    north = lat + (code.m > 2 ? 2 : 1) * 15;
    west = lng + (code.m%2 == 0 ? 1 : 0) * 22.5;
    east = lng + (code.m%2 == 0 ? 2 : 1) * 22.5;
    return {"south":south/3600, "west":west/3600, "north":north/3600, "east":east/3600};
  }
